...
module.exports = function(homebridge) {
  ...
  homebridge.registerAccessory("homebridge-govee-led", "Kitchen Strip", goveeKitchenLEDStrip);
}
...
function goveeKitchenLEDStrip(log, config) {
  this.log = log;
  this.mac = "A4:C1:38:1B:37:13"
...
goveeKitchenLEDStrip.prototype = {
  isLightOn: function(next) {
    return next(null, this.on);
  },
